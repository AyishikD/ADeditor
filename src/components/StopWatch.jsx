...
const StopWatch = () => {
    ...
    return (
        <div className='absolute bottom-5 right-5 flex gap-3 justify-center items-center'>
...
function Timer(props) {
    return (
        <div className="text-white hover:text-neutral-400 text-xl font-medium font-mono">
