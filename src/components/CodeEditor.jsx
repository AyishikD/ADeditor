...

            {
                ...
                <>
                    ...
                    <div className="flex flex-row border-2 border-t-0 border-gray-600 gap-4" >
                        <Link to="/" className='mt-1.5 ml-2 md-1'>
                        ...
                        <div className="dropdownInner mt-1 md-1">
                            <LanguagesDropdown onSelectChange={onSelectChange} Userlanguage={language} />
                        </div>
                        <div className="dropdownInner mt-1">
                            <ThemeDropdown handleThemeChange={handleThemeChange} theme={theme} />
                        </div>
                        <div className="px-4 justify-end mt-1 md-1">
                        ...
                        <div className="px-4  mx-auto justify-end flex items-center" style={{
                            ...
                            <button onClick={copyToClipboard} type="button" id="copytxt" className="flex items-center py-2 px-4 mr-3  text-xs font-medium  rounded-lg border focus:outline-none hover:bg-gray-700 hover:text-blue-700 focus:z-10  focus:ring-gray-500 bg-gray-800 border-gray-600 hover:text-white hover:bg-gray-700">
                                <FaRegCopy fontSize={16} color="white" />
                            </button>
                            ...
                            <button
                                ...
                                onClick={handleCompile} type="button" className="text-white bg-rose-400 hover:bg-rose-800   focus:outline-none font-medium rounded-lg text-sm px-3 py-2 text-center inline-flex items-center focus:ring-[#2557D6]/50 mr-2">
                            ...
                            <button onClick={downloadTxtFile} type="button" className="text-white bg-rose-400 hover:bg-rose-800   focus:outline-none font-medium rounded-lg text-sm px-3 py-2 text-center inline-flex items-center focus:ring-[#2557D6]/50 mr-2">
                                {"Save Code"}
                            </button>

                            <button onClick={resetCode} type="button" className="text-white bg-rose-400 hover:bg-rose-800   focus:outline-none font-medium rounded-lg text-sm px-3 py-2 text-center inline-flex items-center focus:ring-[#2557D6]/50 mr-2">
                                {"Erase Code"}
                            </button>
